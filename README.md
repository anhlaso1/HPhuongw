...
<body>
    <div id="main">
        <div id="wrap">
            <div id="text" style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif ;">
                <div id="code">
                    <font color="#000"><span class="say">Chúc mừng 8/3 đến những bông hoa rực rỡ đã gặp và làm bạn với H những
                            năm tháng quaaaa!!</span><br>
                        <span class="say"> </span><br>
                        <span class="say">Hello con lợn nhựa, T xin chúc cậu mãi xinh đẹp, đáng yêu, luôn hạnh phúc.
                            Chúc M luôn gặp may mắn trong cuộc sống và vui vẻ mọi lúc mọi nơi. Nụ cười của cậu còn
                            sáng hơn ánh mặt trời đấyyyyyy.</span><br>
                        <span class="say">Chúc M ngày gần 20/10 thật vui vẻ và tràn đầy sự xinh đẹp cùng với nhiều yêu
                            thương</span><br>
                        <span class="say">Đọc đến đây là được rồi, hết mất rồi nha đừng cố nhìn nữa. Thân Ái và quyết thắng Maixiuu à hehee </span><br>
                        <span class="say"><span class="space"><img width="100px" height="100px" src="image/tym.png"
                                    alt=""><br>
                                <span class="say"><span class="space"></span> --Ngọc Hải-- </span>
                    </font>
                    </p>
                </div>
            </div>
    ...
    <body>
        <audio id="myAudio" autoplay>
            <source src="music/Chungtakhongthuocvenhau.mp3" type="audio/mp3" />
        </audio>
